# multi-language-sdk Specification

## Purpose
Define the Rust, Go, and Python SDK expectations for connecting to pgapp-server,
calling Cache and MQ APIs, preserving serialization semantics, and exposing
stable errors.
